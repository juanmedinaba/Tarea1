...
public class PCirculo extends javax.swing.JFrame {
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        Circulo circulo1 = new Circulo(Double.parseDouble(txtRadio.getText()));
        
        circulo1.calcularArea();
        circulo1.calcularPerímetro();        
        txtArea.setText(String.valueOf(circulo1.calcularArea()));
        txtPerimetro.setText(String.valueOf(circulo1.calcularPerímetro()));
